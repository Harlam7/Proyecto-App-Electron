// $(function () {
//     showSwal = function (type, estudiante) {
//         'use strict';
...
//             }).then((result) => {
//                 if (result.value) {
//                     window.ipcRender.send('deleteClient', estudiante);
...
//             <td class="text-center"><button type="button" class="btn btn-danger" onclick="showSwal('passing-parameter-execute-cancel', '${clients[i].estudiante}')">Eliminar</button></td>
//             </tr>
//         `;
//     }
...
//         let { estudiante, matricula, matriculaenero, 
