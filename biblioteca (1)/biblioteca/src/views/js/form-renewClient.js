...
btnCancelar.addEventListener('click', () => {
    location.href = './renewClient.html';
});
...
const renewClient = (data) => {
    window.ipcRender.send('renewClient', data);
...
if (localStorage.getItem('reload') == '1') {
    ...
    window.ipcRender.invoke('confirmRenewClient').then((confirm) => {
